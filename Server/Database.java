...
public class Database
{
	...
	public void setConnection(String fn) throws IOException
	{
		...
		// Use a FileInputStream as input to the Properties object for the
	...
	public ArrayList<String> query(String query)
	{
		...
		// Using the statement object executeQuery using the input query (Return
		// the ResultSet)
		// Use a while loop to process the rows - Create a , delimited record
		// from each field
